...
type = 'inline',
data = {
{{text = '⌔ FALCON 𝘴𝘰𝘳𝘶𝘤𝘦 .',url="t.me/uPDST"}},
}
}
...
{{text = '⌔ قناه التحديثات .',url="t.me/uPDST"}},
{{text = '⌔ رجوع .',data="Can"}},
}
}
...
os.execute('curl -s https://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@raw.githubusercontent.com/falcondevv/uu/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/uPDST&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
...
reply_to_message_id=msg.id,
reply_markup=markup(nil,{{{text = '⌔ FALCON 𝘴𝘰𝘳𝘶𝘤𝘦 .',url="t.me/uPDST"}}})
})
end
end
if not redis:get(bot_id..":"..msg.chat_id..":settings:singforme") then
