...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or "فالكون"
SudosS = {7935841341}
Sudos = {sudoid,7935841341}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '⌔ FALCON 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/F0aLCoN"}},
}
}
...
{{text = '⌔ قناه التحديثات .',url="t.me/F0aLCoN"}},
{{text = '⌔ رجوع .',data="Can"}},
}
}
...
{{text = '⌔ تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "فالكون"),data="delnamebot"}},
...
os.execute('curl -s https://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@raw.githubusercontent.com/falcondevv/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/F0aLCoN&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"*⌔︙الساعه الان : ( "..os.date("%I:%M%p").." ) .*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"حجي اسمي "..(redis:get(bot_id..":namebot") or "فالكون"),"يابه اسمي "..(redis:get(bot_id..":namebot") or "فالكون"),"اني لقميل "..(redis:get(bot_id..":namebot") or "فالكون"),(redis:get(bot_id..":namebot") or "فالكون").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end 
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "فالكون") then
...
local UserId_Info = bot.searchPublicChat("BFBBT")
if UserId_Info.id then
...
reply_to_message_id=msg.id,
reply_markup=markup(nil,{{{text = '⌔ FALCON 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/F0aLCoN"}}})
})
end
end
if not redis:get(bot_id..":"..msg.chat_id..":settings:singforme") then
...
return send("sendphoto",{
chat_id=msg.chat_id,
photo="https://t.me/F0aLCoN",
caption=('*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 FALCON .\n\n*[⌔  FALCON 𝘤𝘩𝘢𝘯𝘯𝘦𝘭 .](http://t.me/F0aLCoN)*\n\n*[⌔  𝘪𝘯𝘧𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 .](http://t.me/uPDST)*\n\n*[⌔  FALCON 𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .](http://t.me/BFBBT)*\n\n*[⌔  𝘣𝘰𝘵 FALCON .](http://t.me/Qjfbot)'),
reply_to_message_id=msg.id,
parse_mode="markdown",
reply_markup=markup(nil,{{{text = '⌔  FALCON 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/F0aLCoN"}}})
})
